...
The Pandas Murder Mystery es una lección autodidacta para aprender los conceptos y comandos de la librería Pandas en Python. El proyecto consiste en explorar la base de datos de un crimen y resolver el siguiente caso: 

"Te entregaron el informe del lugar del crimen, pero de alguna manera lo perdiste. Recordas vagamente que el crimen fue un ​asesinato​ que ocurrió en algún momento el ​15 de enero de 2018​ y que tuvo lugar en ​Pandas City​."

## Estado del proyecto
El proyecto está terminado. Todas las funcionalidades planificadas se han implementado y probado.
...
```python
# Paso 1: Buscar en informe del asesinato ocurrido en Pandas City el 2018-01-15
...
# Paso 2: Buscar en person los Person_Id de los dos testigos basándonos en la descripción del caso
...
# Paso 3: Buscar en interview los Person_Id identificados en el Paso 2
...
# Paso 4: Buscar en getfitnow_checkin las personas que ingresaron al gimnasio el 2018-01-09
...
# Paso 6: Buscar en getfitnow_members el id de las personas que aparecen en miembros_48Z
# id persona1
id_persona1 = '48Z7A'
...
# Paso 7: Buscar en person el nombre de la persona1 y la persona2
...
# Paso 8: Buscar en drivers_license los License_Id
...
# Paso 9: Ejecutar el código siguiente con el posible sospechoso:
...
# Paso 10: Buscar en interview el Person_Id de Jeremy Bowers y leer la transcripción de la entrevista
...
# Paso 11: Definir variables que aparecen en la transcripción
color = 'Red'
marca_auto = 'Tesla'
modelo_auto = 'Model S'
...
# Paso 13: Cambiar el formato de la fecha en facebook_event_checkin
...
# Paso 15: Filtrar facebook_event_checkin por rango de fechas y nombre del evento
...
# Paso 17: Buscar en person el Id de la primera persona que aparece en conteo_person_id_3_veces
person_id_persona1 = 24556
persona1 = person[person['Id'] == person_id_persona1]
persona1

# Paso 18: Buscar en person el Id de la segunda persona que aparece en conteo_person_id_3_veces
person_id_persona2 = 99716
persona2 = person[person['Id'] == person_id_persona2]
persona2

# Paso 19: Buscar en drivers_license el Id de Miranda Priestly dado que la sospechosa es mujer para verificar que cumpla con la transcripción de la declaración del asesino
...
- **NumPy**: Librería de Python para el cálculo numérico y el manejo de matrices.

## Personas Desarrolladores del Proyecto
Este proyecto fue desarrollado por:

- **Sergio Parada Dommarco** - [spd1248](https://github.com/spd1248)
- **Alain Medel Mejía** - [AlainMm](https://github.com/AlainMm)
- **Yesica Méndez** - [](https://github.com/)

Para más información sobre los desarrolladores, consulta sus perfiles en GitHub.

## Licencia
Este proyecto está bajo la Licencia MIT. Para más detalles, consulta el archivo [LICENSE](LICENSE).

## Conclusión
El proyecto The Pandas Murder Mystery ha sido una muy buena oportunidad para aplicar la librería Pandas en Python. A través de la exploración, análisis y visualización de datos, hemos podido resolver un caso ficticio de asesinato.
...
¡Gracias por tu interés en The Pandas Murder Mystery!
```
